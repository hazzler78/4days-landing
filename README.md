...
Nyckeln ska **inte** committas till git. Verifieringsfilen `https://www.4days.ai/{din-nyckel}.txt` serveras via `/api/indexnow-verify` (kräver `INDEXNOW_API_KEY` i Vercel).
